...
class Track(BaseDocumentManager):
  """Provides helper methods to manage Track documents.  All Track documents
  built using these methods will include a core set of fields (see the
  _buildCoreTrackFields method).  We use the given product id (the Track
  ...
  def _buildSortMenu(cls):
    """Build the default set of sort options used for Track search.
    Of these options, all but 'relevance' reference core fields that
    all Tracks will have."""
  ...
  @classmethod
  def removeTrackDocByPid(cls, pid):
  ...
  def updateRatingsInfo(cls, doc_id, avg_rating):
    """Given a models.Track entity, update and reindex the associated
...
# 'accessor' convenience methods
  ...
  def getPID(self):
    """Get the value of the 'pid' field of a Track doc."""
    return self.getFieldVal(self.PID)

  def getName(self):
    """Get the value of the 'name' field of a Track doc."""
    return self.getFieldVal(self.PRODUCT_NAME)

  def getDescription(self):
    """Get the value of the 'description' field of a Track doc."""
    return self.getFieldVal(self.DESCRIPTION)

  def getCategory(self):
    """Get the value of the 'cat' field of a Track doc."""
    return self.getFieldVal(self.CATEGORY)

  def setCategory(self, cat):
    """Set the value of the 'cat' (category) field of a Track doc."""
    return self.setFirstField(search.NumberField(name=self.CATEGORY, value=cat))

  def getAvgRating(self):
    """Get the value of the 'ar' (average rating) field of a Track doc."""
    return self.getFieldVal(self.AVG_RATING)

  def setAvgRating(self, ar):
    """Set the value of the 'ar' field of a Track doc."""
    return self.setFirstField(search.NumberField(name=self.AVG_RATING, value=ar))

  def getPrice(self):
    """Get the value of the 'price' field of a Track doc."""
  ...
  @classmethod
  def _buildTrackFields(cls, pid=None, category=None, name=None,
    ...
    fields = cls._buildCoreTrackFields(
  ...
  def _createDocument(
    ...
    if pid and category and name:
      ...
      resfields = cls._buildTrackFields(
  ...
  def buildTrack(cls, params):
    ...
    def _tx():
      ...
      prod = models.Track.get_by_id(params['pid'])
      if prod:  #update
        prod.update_core(params, doc_id)
      else:   # create new entity
        prod = models.Track.create(params, doc_id)
      prod.put()
      return prod
